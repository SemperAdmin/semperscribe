    ...
    <div className="min-h-screen bg-background text-foreground py-12 px-6 sm:px-10">
      <div className="max-w-3xl mx-auto space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>
            Classified material is never permitted. CUI is governed by the system, not by this application: DoDI 5200.48 paragraph 3.3.c requires CUI to be processed on a DoD information system at the moderate confidentiality level, and paragraph 3.10.b bars non-DoD information systems for official business involving CUI unless approved. Whether this application, served from a non-DoD host and run in a browser on your system, is permitted for CUI is your authorizing official's decision. Until your command has granted that approval, do not enter CUI. Personally Identifiable Information (PII) such as names and EDIPI, and Protected Health Information (PHI), may be entered at the user's discretion and risk: the formatter never transmits it, and every export is scanned for SSN and EDIPI patterns and PHI keyword clusters before the file is written (Section 5B). One consequence follows from the DoD CUI Registry: personal information about a service member, once it is part of a record, is CUI in the Privacy category (marking PRVCY, authorities 5 USC 552a(b), OMB M-17-12, DoDI 5400.11). A NAVMC 10132, a NAVMC 118(11) entry, a NAVMC 10274 or a Counseling Worksheet produced for a real Marine is therefore CUI once it exists, and the condition above on your system and your authorizing official's approval applies to it. Sample data and drafts about no real person are not. The user bears sole responsibility for the content they enter, for any Privacy Act obligation it creates (Section 7), and for the use they make of generated output.
          </p>
          <p>
